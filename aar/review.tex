...
In Chapter \ref{Chapter1}, a naive implementation for Gaussian Process prediction was presented in \cref{alg: Unoptimized_GPR}. While this does provide a simple and convenient way to produce predictions for a regression task, it is not all smooth sailing after this. Unfortunately, there are a number of problems with this algorithm in terms of scalability where various bottlenecks are present on lines $1,2$ and $4$.
