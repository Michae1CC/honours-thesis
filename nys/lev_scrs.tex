...
\begin{proof}
    ...
    \end{equation*}
\end{proof}
From now on (unless otherwise stated) the regularization parameter seen in \Cref{eq: rid-lev-reg-param} will always be used for ridge leverage scores where the notation
\begin{equation*}
