...
\[
    ...
    = \hat{\bm{Q}} \hat{\bm{R}}.
\]
This alternate decomposition is called the reduced (or sometimes the thin) $QR$ factorisation. The following two theorems on the $QR$ factorization are stated without proof.
