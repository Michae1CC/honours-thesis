\subsection{MINRES and CG Prediction Errors}
\hfill
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{img/pred/3D_spatial_network/pred_acc/lin_cmp-sigma=1.0.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{img/pred/abalone/pred_acc/lin_cmp-sigma=1.0.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{img/pred/rastrigin/pred_acc/lin_cmp-sigma=2.1.png}
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[scale=0.4]{img/pred/magic04/pred_acc/lin_cmp-sigma=1.0.png}
%     \caption{Comparison of MINRES and CG Prediction Errors for the Magic data set.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{img/pred/stock_market/pred_acc/lin_cmp-sigma=10.0.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{img/pred/temperature_data/pred_acc/lin_cmp-sigma=10.0.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=0.4]{img/pred/Wine_data/pred_acc/lin_cmp-sigma=2.1.png}
