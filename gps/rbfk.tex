...
%         \end{tikzpicture}
%     }%
%     \caption{A graph of the Gaussian RBF from \Cref{defe: grbfk} for $d=2$. Evidently, a larger value of $\sigma$ slows the rate of decay increasing the similarity between the same pair of samples.}%
