...
Thus, once data has been observed, finding a mean and covariance for $\bm{f}_{\star}$ involves a direct application of theorem \ref{theorem: cond_of_MVN} which gives
\begin{align*}
